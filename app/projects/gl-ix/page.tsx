      ...
      <div className="max-w-6xl mx-auto">
        ...
        <article className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <div className="mb-16 border border-gray-300 dark:border-white/10 p-0 overflow-hidden aspect-video">
            <img
              src="/images/projects/gl-ix/screenshot.jpg"
              alt="GL-IX infrastructure overview"
            ...
            <div className="p-6 border-t border-gray-300 dark:border-white/10">
              <p className="text-sm text-gray-500 dark:text-gray-500 font-light m-0">GL-IX Infrastructure Overview</p>
            </div>
          </div>
